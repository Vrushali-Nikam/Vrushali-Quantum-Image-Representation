...
% AUTHORS - Springer Nature Journal Format
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Define Springer Nature author commands for article class
\makeatletter
\newcommand{\fnm}[1]{#1}
...
\author{%
Vrushali Nikam$^{1*}$ \and
Shirish Sane$^{2\dagger}$ \and
Smita Nirkhi$^{3*\dagger}$%
}
...
% Affiliations in Springer Nature format
\vspace{-2em}
\begin{center}
\small
$^{1*}$\orgdiv{Department of Computer Engineering}, \orgname{MET’s Institute of Engineering, BKC}, \orgaddress{\street{Adgaon}, \city{Nashik}, \postcode{422003}, \state{Maharashtra}, \country{India}}.\\[0.3em]
$^{2}$\orgdiv{Department of Computer Engineering}, \orgname{GES's,R.H. Sapat College of Engineering, Management studies and Research}, \orgaddress{\street{College Road}, \city{Nashik}, \postcode{422005}, \state{Maharashtra}, \country{India}}.\\[1em]
$^{3*}$\orgdiv{Symbiosis Institute of Technology, Nagpur Campus}, \orgname{Symbiosis International (Deemed University)}, \orgaddress{\street{Nagpur}, \city{Nagpur}, \postcode{440008}, \state{Maharashtra}, \country{India}}.\\[0.3em]
*Corresponding author(s). E-mail(s): \href{vrushali.nik@gmail.com}{vrushali.nik@gmail.com};{smita.singh@siu.edu.in}\\
Contributing authors: \href{mailto:principal@ges-coengg.org }{principal@ges-coengg.org };\\[0.5em]
...
TNR \cite{ref4} & 16 & $\sim$2,470 & $\sim$920 & Basis State & Yes & Sign bit overhead \\
...
\noindent\textbf{Author contributions} Material preparation, data collection, analysis, and manuscript writing were performed by  Vrushali Nikam.
